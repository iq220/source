Create View [dbo].[vwContractPropertyV0] as (
    Select 
    ...
    on ws.WorkflowId = w.Id and ws.StateValue  = wfip.[Value] and wfp.Name='State'
    Left Outer Join 
    (select
