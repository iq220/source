Create View [dbo].[vwContractActionV0] as (
    Select 
        ...
        CASE WHEN ca.ProvisioningStatus = 3  THEN 0
            WHEN ca.ProvisioningStatus = 4  THEN 0
            WHEN ca.ProvisioningStatus = 5  THEN 1
            ELSE ca.ProvisioningStatus
        End as ContractActionProvisioningStatus,
